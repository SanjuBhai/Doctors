  ...
  <div class="row doctor-detailBox">
    ...
    <div class="col-md-12">
      <div class="row detail-footer ">
          ...
          <div class="col-md-4"><a href="{{ route('book-appointment', array('doctor' => $val->slug) ) }}" class="foot-link"><i class="fa fa-calendar-times-o" aria-hidden="true"></i> Book Appointment</a></div>
      </div>
    </div>
  </div>
@endforeach