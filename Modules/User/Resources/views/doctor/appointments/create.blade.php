...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"> Add education </h1>
    </div>
</div>
    ...
    <div class="col-xs-12">
        ...
        <form role="form" method='post' action=''>
            ...
            <div class="form-group">
                ...
                <input type='text' class="form-control" id='institute' name='institute' required value="{{ request('institute') }}">
            ...
            <div class="form-group">
                ...
                <input type='text' class="form-control numeric" id='from_year' name='from_year' required value="{{ request('from_year') }}" maxlength='4'>
            ...
            <div class="form-group">
                ...
                <input type='text' class="form-control numeric" id='to_year' name='to_year' required value="{{ request('to_year') }}" maxlength='4'>
