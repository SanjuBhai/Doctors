    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                <!-- @include('user::layouts.admin.sections.messages')
                @include('user::layouts.admin.sections.notifications') -->
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="{{ route('admin.change-password') }}"><i class="fa fa-fw fa-lock"></i> Change Password</a>
                        </li>
                        <li class="divider"></li>
                        <li>
            ...
            @include('user::layouts.admin.sections.nav')
        </nav>
