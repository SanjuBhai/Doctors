...
Route::group(['middleware' => 'web', 'namespace' => 'Modules\User\Http\Controllers\Admin', 'prefix' => 'admin'], function()
{
	...
	Route::post('doctors/verify', 'DoctorController@verifyRegistrationNumber')->name('admin.doctors.verify');
...
Route::group(['middleware' => 'web', 'namespace' => 'Modules\User\Http\Controllers\Doctor', 'prefix' => 'doctor'], function()
{
	...
	Route::get('calendar', 'CalendarController@index')->name('doctor.calendar');
	Route::post('calendar', 'CalendarController@store');
	Route::post('calendar/delete', 'CalendarController@delete')->name('doctor.calendar.delete');
